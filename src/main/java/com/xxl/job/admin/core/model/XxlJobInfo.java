...
public class XxlJobInfo {
	...
	//是否覆盖上次的Cron配置,true时直接覆盖注册中心里的Cron配置.用于自动注册模块
	private boolean overWriteCron;//
	...
	public boolean isOverWriteCron() {
		return overWriteCron;
	}

	public void setOverWriteCron(boolean overWriteCron) {
		this.overWriteCron = overWriteCron;
	}
