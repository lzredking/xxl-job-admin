...
public class XxlJobServiceImpl implements XxlJobService {
	...
	public Map<String, Object> pageList(int start, int length, int jobGroup, String jobDesc, String executorHandler, String filterTime) {
		...
		// page list
		List<XxlJobInfo> list = xxlJobInfoDao.pageList(start, length, jobGroup, jobDesc, executorHandler,null);
	...
	@Override
	public ReturnT<String> regist(XxlJobInfo jobInfo) {
		// valid
		XxlJobGroup group = xxlJobGroupDao.load(jobInfo.getJobGroup());
		if (group == null) {
			return new ReturnT<String>(ReturnT.FAIL_CODE, (I18nUtil.getString("system_please_choose")+I18nUtil.getString("jobinfo_field_jobgroup")) );
		...
		//add yangkunguo 20180525
		List<XxlJobInfo> list=xxlJobInfoDao.pageList(0,10,jobInfo.getJobGroup(),null,jobInfo.getExecutorHandler(),jobInfo.getGlueType());
		...
		if(list.isEmpty()){
			...
			// update in db
			jobInfo.setId(list.get(0).getId());
			
			if(jobInfo.isOverWriteCron())
				update(jobInfo);
		}
	...
	public ReturnT<String> update(XxlJobInfo jobInfo) {
		...
		//add ykg
//		if(exists_jobInfo.getGlueUpdatetime()==null)
//			exists_jobInfo.setGlueUpdatetime(new Date());
	...
	public ReturnT<String> remove(int id) {
		...
		try {
			...
			//add yangkunguo 20180529 删除已经不存在的Job信息,原系统中没有删除。
			xxlJobInfoDao.deleteTriggers(xxlJobInfo.getJobGroup(), xxlJobInfo.getId());
			xxlJobInfoDao.deleteJobDetails(xxlJobInfo.getJobGroup(), xxlJobInfo.getId());
			xxlJobInfoDao.deleteCronTriggers(xxlJobInfo.getJobGroup(), xxlJobInfo.getId());
